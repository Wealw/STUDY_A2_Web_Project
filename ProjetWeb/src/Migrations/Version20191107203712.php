 ...
 */
final class Version20191107203712 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event ADD event_periode VARCHAR(50) DEFAULT NULL');
        $this->addSql('ALTER TABLE participation ADD event_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event DROP event_periode');
        ...
        $this->addSql('ALTER TABLE participation DROP event_id');
    }
}
